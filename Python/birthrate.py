...
def birth():
    ...
    line_chart.add('China', birth_sheet.loc["China"][4:61])
    line_chart.add('Thailand', birth_sheet.loc["Thailand"][4:61])
    line_chart.add('Japan', birth_sheet.loc["Japan"][4:61])
    line_chart.add('United States', birth_sheet.loc["United States"][4:61])
    line_chart.render_to_file('Graph SVG/Birthrate.svg')
birth()
