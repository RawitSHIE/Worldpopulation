...
def death():
    ...
    line_chart.add('China', death_sheet.loc["China"][4:61])
    line_chart.add('Thailand', death_sheet.loc["Thailand"][4:61])
    line_chart.add('Japan', death_sheet.loc["Japan"][4:61])
    line_chart.add('United States', death_sheet.loc["United States"][4:61])
    line_chart.render_to_file('Graph SVG/Deathrate.svg')
death()
