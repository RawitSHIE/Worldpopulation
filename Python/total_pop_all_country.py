...
def gdp():
    ...
    line_chart.add('China', gdp_sheet.loc["China"][5:61:4])
    line_chart.add('Thailand', gdp_sheet.loc["Thailand"][5:61:4])
    line_chart.add('Japan', gdp_sheet.loc["Japan"][5:61:4])
    line_chart.add('United States', gdp_sheet.loc["United States"][5:61:4])
